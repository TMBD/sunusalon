  ...
  <table class="table table-condensed">
    <div class="panel-heading"> 
      <h3 class="panel-title">
        Liste des clients 
        <?php 
          echo " <a href='".INSCRIPTION_VIEW_ROUTE."?user=employe&_action=add'>  <div class = 'edit btn btn-primary  glyphicon glyphicon-plus '> </div>  </a> "
        ?>
        <!-- <form method = 'GET' action="<?php //echo AJOUT_EMPLOYE_VIEW_ROUTE ?>">
          <input type="hidden" name="_action" value="add">
          <input type = 'submit' class = 'btn btn-primary  glyphicon glyphicon-plus' value = 'Ajouter'> 
        </form> -->
      </h3>
    </div>
    <thead>
    ...
    ?>
      ...
      <?php
            ...
            "<tr id = '".$cle."' >
                ...
                "<td width='15%' align='center'>   <a href='".INSCRIPTION_VIEW_ROUTE."?email=".$value['email']."&user=client&_action=edit'>  <div id = 'edit_".$cle."' class = 'edit btn btn-default  glyphicon glyphicon-edit edite'> </div>  </a> </td>".
